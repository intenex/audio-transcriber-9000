...
**Unit — always run, no network, no models (272 on macOS / 276 on the iOS simulator as of 2026-07-27; totals incl. skipped gated suites: 288 / 285). On a real iPhone the same 285 run with only 7 skipped, because the device has the app-container marker (gated real-mic recorder + real-model local-engine suites run there).**
